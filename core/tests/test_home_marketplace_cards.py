...
class HomeMarketplaceCardsTests(TestCase):
    ...
    def test_home_has_bento_and_product_rows(self):
        ...
        self.assertNotContains(response, 'hm-feed-carousel')
        self.assertContains(response, 'hm-tradeflow-strip')
